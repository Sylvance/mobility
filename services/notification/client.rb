...
def client_call
  ...
  stub = Mobility::Services::NotificationServices::Stub.new('0.0.0.0:50052', :this_channel_is_insecure)
  # 2. build request object
  req = Mobility::Services::ListNotificationsRequest.new(page_size: 1)
